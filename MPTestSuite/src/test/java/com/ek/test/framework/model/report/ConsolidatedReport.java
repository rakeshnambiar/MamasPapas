package com.ek.test.framework.model.report;

import com.ek.test.framework.model.ReportModel;
...
import static com.ek.test.framework.report.MergeReports.FILE_PATH;
...
public class ConsolidatedReport {
    ...
    private com.ek.test.framework.report.MergeReports mergeReports;
    ...
    public static void main(String a[]) {
        com.ek.test.framework.report.ConsolidatedReport consolidatedReport = new com.ek.test.framework.report.ConsolidatedReport();
        try {
